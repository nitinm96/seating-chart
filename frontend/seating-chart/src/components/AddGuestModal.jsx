        ...
        <div className='fixed inset-0 bg-black/50 flex justify-center items-center z-50' onClick={(e) => e.stopPropagation()}>
            <div className='flex flex-col bg-white rounded-2xl p-6 gap-y-2 mx-5'>
                <div className="grid gap-6">
                    {guestAdded ? <div className='text-md font-normal'>{successMessage}</div>  
                    :
                    <>
                        <div className='font-bold text-xl'>Add Guest</div>
                            ...
                            <div className='flex justify-center items-center gap-x-6'>
                                <button type="button" onClick={addGuest} className=" text-white bg-blue-500 border-blue-500 border-2 rounded-lg px-8 py-2 cursor-pointer hover:opacity-70">Add Guest</button>
